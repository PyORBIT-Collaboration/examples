...
parser.add_argument("--outputDirectory", dest='outputDirectory', default="WasteBeamSplitGeneralNewStripperChicaneFieldAddedCleanNewTestY_Inject3NoScale", help="Where to put output")
...
for currentPart in range(1,nPartsChicane+1):
	for currentPart2 in range(-1,nPartsChicane2+1):
		...
		chicane12=None
		#find drift node before chicane12 (DB23)
		driftDB23=None
		for node in nodes:
