...
parser.add_argument("--outputDirectory", dest='outputDirectory', default="OG_Injection_SBEND", help="Where to put output")
...
print "Read MAD."
teapot_latt.readMAD("MAD_Injection_Region_Lattice/OG_Injection_InjectionRegionOnly_Chicane_Replaced_With_SBENDS_onlyChicane2.LAT","RING")
