...
class MyScorer(Scorer):
	...
	def getScore(self,trialPoint):
		...
		print "self.b.px(0)=",self.b.px(0), " xpavg=",xpavg
		return score	
...
for currentPart in range(1,nPartsChicane+1):
	for currentPart2 in range(-1,nPartsChicane2):
		...
		teapot_latt_full.readMAD("MAD_Injection_Region_Lattice/InjectionRegionOnly_Chicane_Replaced_With_Kickers.LAT","RING")
