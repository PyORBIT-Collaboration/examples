...
nPartsChicane=1
outputDirectory="WasteBeamSplitPencil"
...
for currentPart in range(nPartsChicane+1):
	...
	print "Read MAD."
	inj_latt_start.readMAD("MAD_Injection_Region_Lattice/InjectionRegionOnly_Chicane_Replaced_With_Kickers_onlyChicane2_testSplit.LAT","RING")
	...
	print "bunch_in.getSize()=%d"%bunch_in.getSize()
