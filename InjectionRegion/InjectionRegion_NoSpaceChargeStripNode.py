...
fileOut=open("emmit_DH11_3pre.txt",'w')
fileOut.close()
fileOut=open("print_DH11_3pre.txt",'w')
fileOut.close()

fileOut=open("emmit_DH12_3pre.txt",'w')
fileOut.close()
fileOut=open("print_DH12_3pre.txt",'w')
fileOut.close()

myEmitNode_DH11_3pre=Calc_Emit("MyEmitNode_DH11_3pre",True,"emmit_DH11_3pre.txt")
myPrintNode_DH11_3pre=Print_Node("MyPrintNode_DH11_3pre",True,"print_DH11_3pre.txt")
myEmitNode_DH12_3pre=Calc_Emit("MyEmitNode_DH12_3pre",True,"emmit_DH12_3pre.txt")
myPrintNode_DH12_3pre=Print_Node("MyPrintNode_DH12_3pre",True,"print_DH12_3pre.txt")
...
if args.doDipoleKickers:
	for node in nodes2:
		if (node.getName().strip()=="DH_A11"):
			...
			node.addChildNode(myEmitNode_DH11_3pre,AccNode.BODY,3)
			node.addChildNode(myPrintNode_DH11_3pre,AccNode.BODY,3)
		...
		if (node.getName().strip()=="DH_A12"):
			...
			myDipole_DH_A12.setFunctionXP_mRigidity(deltaxp_m_rigidity)
			myDipole_DH_A12.setFunctionX_mRigidity(deltax_m_rigidity)			
...
fileOut.close()
fileOut=open("print_beg_DH11.txt",'w')
fileOut.close()
fileOut=open("print_end_DH11.txt",'w')
fileOut.close()
fileOut=open("print_DH11_2.txt",'w')
fileOut.close()
fileOut=open("print_DH11_3.txt",'w')
fileOut.close()
...
fileOut.close()
fileOut=open("print_DH12_3.txt",'w')
fileOut.close()
fileOut=open("print_end_DH12.txt",'w')
fileOut.close()
myPrintNode_beg=Print_Node("MyPrintNode_Beg",True,"print_beg.txt")
myPrintNode_beg_DH11=Print_Node("MyPrintNode_beg_DH11",True,"print_beg_DH11.txt")
myPrintNode_end_DH11=Print_Node("MyPrintNode_end_DH11",True,"print_end_DH11.txt")
myPrintNode_DH11_2=Print_Node("MyPrintNode_DH11_2",True,"print_DH11_2.txt")
myPrintNode_DH11_3=Print_Node("MyPrintNode_DH11_3",True,"print_DH11_3.txt")
...
myPrintNode_DH12_3=Print_Node("MyPrintNode_DH12_3",True,"print_DH12_3.txt")
...
fileOut.close()
fileOut=open("emmit_beg_DH11.txt",'w')
fileOut.close()
fileOut=open("emmit_end_DH11.txt",'w')
fileOut.close()
fileOut=open("emmit_DH11_2.txt",'w')
fileOut.close()
fileOut=open("emmit_DH11_3.txt",'w')
fileOut.close()
...
fileOut.close()
fileOut=open("emmit_DH12_3.txt",'w')
fileOut.close()
fileOut=open("emmit_end_DH12.txt",'w')
fileOut.close()
myEmitNode_beg=Calc_Emit("MyEmitNode_Beg",True,"emmit_beg.txt")
myEmitNode_beg_DH11=Calc_Emit("myEmitNode_beg_DH11",True,"emmit_beg_DH11.txt")
myEmitNode_end_DH11=Calc_Emit("myEmitNode_end_DH11",True,"emmit_end_DH11.txt")
myEmitNode_DH11_2=Calc_Emit("MyEmitNode_DH11_2",True,"emmit_DH11_2.txt")
myEmitNode_DH11_3=Calc_Emit("MyEmitNode_DH11_3",True,"emmit_DH11_3.txt")
...
myEmitNode_DH12_3=Calc_Emit("MyEmitNode_DH12_3",True,"emmit_DH12_3.txt")
...
for node in nodes:
	...
	if node.getName().strip() == "DH_A11":
		...
		node.addChildNode(myPrintNode_DH11_2,AccNode.BODY,2)
		node.addChildNode(myPrintNode_DH11_3,AccNode.BODY,3)
		
		node.addChildNode(myEmitNode_DH11_2,AccNode.BODY,2)
		node.addChildNode(myEmitNode_DH11_3,AccNode.BODY,3)		
	if node.getName().strip() == "DH_A12":
		#print node.getName().strip()
		#print node.getnParts()
		...
		node.addChildNode(myPrintNode_DH12_3,AccNode.BODY,3)
		node.addChildNode(myEmitNode_DH12_3,AccNode.BODY,3)		
		#node.setnParts(10)
	if args.printNodes==True:
		path_length=path_length+node.getLength()
		print i, " node=", node.getName()," s start,stop = %4.3f %4.3f "%ring_latt.getNodePositionsDict()[node], " path_length= ",path_length
