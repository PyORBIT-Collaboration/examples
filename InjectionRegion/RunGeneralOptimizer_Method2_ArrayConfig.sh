...
outputDirectory=Method2_strippersNotClosed_ArrayConfig_Weak
outputDirectorySub=Method2_Part1_strippersNotClosed_FloatLength
beamLatticeFileSuffix=(RUR LUL)
#beamLatticeFileSuffix=(RUR)
beamLatticeFilePrefix=OptimizerConfigFiles/DefaultBeamLattice_strippersNotClosed_ArrayConfig_Weak_
