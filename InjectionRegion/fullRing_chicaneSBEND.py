...
print "Read MAD."
teapot_latt.readMAD("MAD_Full_Ring/SNSring_pyOrbitBenchmark.LAT","RING")
...
chicane10.setParam("ANGLE", strength_chicane10)
chicane11.setParam("ANGLE", strength_chicane11)
chicane12.setParam("ANGLE", strength_chicane12)
chicane13.setParam("ANGLE", strength_chicane13)
