...
from orbit.impedances import TImpedance_Node, FreqDep_TImpedance_Node, BetFreqDep_TImpedance_Node
...
ZP = [complex(36904.387, -92036.662),
...
ZM = [complex(-36904.387,  -92036.662),
