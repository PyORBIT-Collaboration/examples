...
#------------------------------------------------------------------------
# Test of the linac error node - straight rotation around x, y, and z axis
# Error Nodes
#
# Script creates lattice:
# 2 drifts and one quad between - quad is rotated
#
# User can set the field in the quad to zero (almost) to see that correlations 
# between x and y axis are not created (rotation of the drift cannot change 
# anything)
#
# The generated bunch tracked through this lattice and we can see the
# correlation dynamics
#
# To check the results we also tracked bunch through set of matrix that
# are created inside the script. The correlation matrix should be the same.
#
# The lattice is for the test only. It is non-physical.
#------------------------------------------------------------------------
...
print "quad rotation angle [grad] = %6.3f "%(rotation_angle*180./math.pi)
